...
- `Installer\Output\ONHARU-Setup-1.2.0.exe`: 권장 설치 파일과 제거 프로그램
- `Release\SHA256SUMS.txt`: 배포 파일 무결성 확인값
- `DISTRIBUTION_GUIDE.md`: Google OAuth와 배포 전 사용자 작업

## 폴더 구조

- `Source`: ONHARU 1.2.0 최종 C# WPF 소스와 자동검사
...
이 스크립트는 EXE 빌드, 버전·OAuth·반복·로그·내보내기·연속 일정·절기와 설정 마이그레이션 검사, 설치 설정 검사, 설치 파일 생성과 SHA-256 계산을 순서대로 수행합니다.

...
foreach ($required in @('PrivilegesRequired=lowest', 'VersionInfoVersion=1.0.1.0', 'Release\ONHARU.exe', 'DestName: "{#AppExeName}"', '{userstartup}', 'Tasks: desktopicon', 'UninstallDisplayIcon')) {

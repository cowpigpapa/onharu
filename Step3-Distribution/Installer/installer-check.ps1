...
foreach ($required in @('AppId={{C43E8BF2-2B16-4CC7-A85B-D18C2AA7D706}', 'PrivilegesRequired=lowest', 'VersionInfoVersion=1.2.0.0', 'Release\ONHARU.exe', 'DestName: "{#AppExeName}"', '{userstartup}', 'Tasks: desktopicon', 'UninstallDisplayIcon')) {

...
#define SetupOutputName "ONHARU-2.2.1-InstallTest"
#else
...
#define SetupOutputName "ONHARU-2.2.1-Setup"
#endif
...
[Files]
Source: "..\Release\ONHARU-2.2.1\ONHARU.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\ONHARU-2.2.1\ONHARU.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\ONHARU-2.2.1\Onharu.LayerHost.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\ONHARU-2.2.1\Onharu.DesktopHook.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\ONHARU-2.2.1\README.md"; DestDir: "{app}"; DestName: "ONHARU-사용설명서.md"; Flags: ignoreversion

...
#define SetupOutputName "ONHARU-2.2.0-InstallTest"
#else
...
#define SetupOutputName "ONHARU-2.2.0-Setup"
#endif
...
[Files]
Source: "..\Release\ONHARU-2.2.0\ONHARU.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\ONHARU-2.2.0\ONHARU.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\ONHARU-2.2.0\Onharu.LayerHost.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\ONHARU-2.2.0\Onharu.DesktopHook.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\ONHARU-2.2.0\README.md"; DestDir: "{app}"; DestName: "ONHARU-사용설명서.md"; Flags: ignoreversion

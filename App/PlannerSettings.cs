...
namespace FamilyPlanner
{
    ...
    {
        [DataMember] public int Version = 16;
        ...
        [DataMember] public string CompletedDisplayMode = "normal";
        ...
        [DataMember] public string StartupPositionMode = "remember";
        [DataMember] public string CloseButtonAction = "minimize";
